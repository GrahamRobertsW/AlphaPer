...
infile=open('../resources/PARSEC021models.dat','r')
con=p2.connect("dbname='parsec' user='postgres' host='localhost'")
cur=con.cursor()
names=[]
end=False
cur.execute("create table years_Z021 (names varchar);")
con.commit()
for i in range(13):
